    ...
    for l in range(0, len(layername)):
        ...
        #depth l,inception module
            ...
            #two branch---do same for L1&L2
                ...
                #three path in Inception module
                    ...
                    #11(128)+17(64)+71(64)
                        ...
                        n.tops[conv_reduce] = L.Convolution(n.tops[last_layer_p[path]], kernel_size = 1,
                                                              num_output=pathCH[path][0], pad_h=0,pad_w=int(math.floor(kernel[l]/2)),
                                                              param=[dict(lr_mult=lr_m, decay_mult=1), dict(lr_mult=lr_m*2, decay_mult=0)],
                                                              weight_filler=dict(type='gaussian', std=0.01),
                                                              bias_filler=dict(type='constant'))
                ...
                n.tops['concat_inception%d_stage%d' % (conv_counter, stage)] = L.Concat(n.tops[last_layer_p[0]], n.tops[last_layer_p[1]], n.tops[last_layer_p[2]], concat_param=dict(axis=1))
...
--weights=/home/vis/sunguanxiong/code/fg-caffe-mpi/cache/model/v0/vgg/final.caffemodel \
...
if __name__ == "__main__":
    ...
    if(exp == 1):
        directory = 'COCO_exp_caffe/pose56/stage3_1331_bn/'
        ...
        for nc in range(0,1):
            ...
            for s in range(2, stage+1):
                layername += ['@'] + ['inception']* 4 + ['C2']*2  +  ['L2']
                kernel +=    [ 0 ] + [ 7 ] * 4  + [1,1]     +  [ 0 ]
                outCH +=     [ 0 ] + [128] * 5  + [np*2] +  [ 0 ]
                stride +=    [ 0 ] + [ 1 ] * 6  +  [ 0 ]
            ...
            writePrototxts(dataFolder, sub_dir, batch_size, layername, kernel, stride, outCH, transform_param, base_lr, d_caffemodel, label_name, 1, lr_mult_distro, 6)
